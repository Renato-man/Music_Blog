...
const AdjacentPostCard = ({ post, position }) => (
    <>
        <div className="absolute rounded-lg bg-center bg-no-repeat bg-cover shadow-md inline-block w-full h-72" style={{ backgroundImage: `url('${post.featrured.url}')` }} />
        ...
        {position === 'LEFT' && (
            <div className="absolute arrow-btn bottom-5 text-center  cursor-pointer bg-pink-600 left-4 rounded-full">
        ...
        {position === 'RIGHT' && (
            <div className="absolute arrow-btn bottom-5 text-center  cursor-pointer bg-pink-600 right-4 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6  text-white w-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
